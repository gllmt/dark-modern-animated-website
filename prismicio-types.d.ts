...
export interface BentoSliceDefaultPrimary {
  ...
  /**
   * Repeatable Zone field in *Bento → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.primary.repeatable[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  repeatable: prismic.GroupField<Simplify<BentoDocumentDataRepeatableItem>>;
}
...
export interface CaseStudiesSliceDefaultPrimary {
  ...
  /**
   * Case Study field in *CaseStudies → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.primary.case_study[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  case_study: prismic.GroupField<
    Simplify<CaseStudiesDocumentDataCaseStudyItem>
  >;
}
...
export interface IntegrationsSliceDefaultPrimary {
  ...
  /**
   * Icons field in *Integrations → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: integrations.primary.icons[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  icons: prismic.GroupField<Simplify<IntegrationsDocumentDataIconsItem>>;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      BentoSlice,
      BentoDocumentDataRepeatableItem,
      ...
      CaseStudiesSlice,
      CaseStudiesDocumentDataCaseStudyItem,
      ...
      HeroSliceDefault,
      IntegrationsSlice,
      IntegrationsDocumentDataIconsItem,
